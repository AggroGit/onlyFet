      ...
      <nav class="contenedor menuSuperior ">
        ...
        <div class="MenuMob" v-bind:class="{ open: open }" @click="AbrirCerrar()">
          ...
          <div class="ContieneElementosMenu ">
            ...
            <b-nav-item v-if="auth.wantToBeInfluencer" class="" to='/profile/propinas'>{{$ml.get('propina').payments}}</b-nav-item>
            <b-nav-item v-if="auth.wantToBeInfluencer" class="" to='/auction/create'>{{$ml.get('auction').createAuction}}</b-nav-item>
