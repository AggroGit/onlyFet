        ...
        <div class="col-md-6">
          <form  @submit.stop.prevent="edit()" >
            ...
            <div class="form-group row">
                <entrada v-model="form.nickname" :label="$ml.get('auth').nickname" :name="'nickname'" :autocomplete="'nickname'" :type="'text'" :autofocus="true" :required="false"></entrada>
            </div>
              <div class="form-group row">
              ...
              <div class="row down-2">
                <div class="col-md-12">
                  ...
                  <div v-if="this.existnickname" class="alert alert-danger">
                    <strong>{{$ml.get('auth').prError}}</strong> {{$ml.get('auth').existNickName}} {{this.form.nickname}}
                  </div>
                </div>
              </div>
