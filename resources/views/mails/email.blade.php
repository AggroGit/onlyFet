...
<head>
    ...
    <title>{{$title?? "Nuevo Mensaje"}}</title>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                        ...
                        <div style="line-height: 35px">
                            ...
                            @else
                            {{$title}} @if($logoInTitle?? false)<span style="color: #{{env('LIGHT_COLOR','#48A999')}};">OnlyFet</span>@endif
                            @endif
                        </div>
                    </td>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">{{env('CONTACT_MAIL','info@mobisoft.works')}}</a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">Todos los derechos reservados. Si no quieres recibir más emails de {{env('APP_NAME','la plataforma')}} haz click en el siguiente enlace: </span>
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                                    <a style="font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;color: {{env('COLOR_TEXT_1','#ffffff')}}; text-decoration: none;font-weight:bold;" href="{{url('/unsuscribe')}}">UNSUBSCRIBE</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
